                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                    <div className="lg:col-span-7">
                        ...
                        <p className="mt-5 text-neutral-600 text-lg leading-relaxed max-w-2xl">
                            Endorphin Healthcare delivers science-backed treatments for
                        ...
                        <div className="mt-8 flex flex-wrap items-center gap-3">
                            ...
                            <Button href="https://app.centerfy.ai/location/hK9kgqxIRE2CoCxSZCzX/page-builder/AeCZaabnRkOoc7FSkDx7" variant="secondary">
                                Start Your Journey
                            </Button>
                        </div>
                        <div className="my-6 flex items-center gap-6 text-sm text-neutral-600">
                            ...
                            <Link href={"https://facebook.com"} target="_blank">
                                <div className="flex items-center gap-2 hover:cursor-pointer hover:underline">
                                    <span className="h-2 w-2 rounded-full bg-blue-400" /> Facebook
                                </div>
                            </Link>
                    ...
                    <div className="lg:col-span-5  lg:block hidden mb-10 ">
                        <div className="relative aspect-[4/3] w-full overflow-hidden rounded-3xl bg-gradient-to-br from-neutral-100 to-neutral-50 shadow-lg">
                            <Image src={"/hero-section.jpg"} alt="hero-image" fill />
                        </div>
                    </div>
                </div>
            </div>
